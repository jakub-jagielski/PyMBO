...
class GPSliceControlPanel:
    ...
    def _create_style_controls(self, parent):
        ...
        line_combo.bind('<<ComboboxSelected>>', self._on_style_change)
        ...
        transparency_combo.bind('<<ComboboxSelected>>', self._on_style_change)
        ...
        size_combo.bind('<<ComboboxSelected>>', self._on_style_change)
    ...
    def _create_axis_controls(self, parent):
        ...
        x_min_entry.bind('<KeyRelease>', self._on_axis_change)
        ...
        x_max_entry.bind('<KeyRelease>', self._on_axis_change)
        ...
        y_min_entry.bind('<KeyRelease>', self._on_axis_change)
